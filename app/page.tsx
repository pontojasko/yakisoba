          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm text-white/60 leading-relaxed">
                O melhor yakisoba da cidade, feito na chapa com ingredientes frescos e muito sabor.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-4">
                <a href="https://www.instagram.com/yaki.hami/" className="h-9 w-9 rounded-full bg-white/10 hover:bg-orange-500 flex items-center justify-center transition-colors duration-200" aria-label="Instagram">
                ...
                <a href="https://www.facebook.com/groups/274184572778076/posts/2916193555243818/" className="h-9 w-9 rounded-full bg-white/10 hover:bg-orange-500 flex items-center justify-center transition-colors duration-200" aria-label="Facebook">
